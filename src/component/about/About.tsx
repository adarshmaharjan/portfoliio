        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <p className="py-6 prose prose-slate">
              I am a Software engineer learning and experiencing the world of coding and programming. I am committed to
              utilizing my skills to further the company's mission and am proficient in various platforms, languages,
              and embedded systems.
            </p>
            <a
              href="https://drive.google.com/file/d/1nUI-tMK35MrgV8m0L2EHR_gWmxWxPOPe/view"
              target="_blank"
